...
import "./home.css"
import p1 from "../img/3.jpg"
import p2 from "../img/2.jpg";
import p3 from "../img/1.jpg";
import Card from '../Cards/Card';
import ArrowForward from '@mui/icons-material/ArrowForward';
import MainPortfolio from '../portfolio page/MainPortfolio';
import LoginSignUp from '../Login/AllLogReg';
    ...
    return (
      <>
        ...
        <div className='contact'>
          <h1 style={{textAlign:"center",marginTop:"100px",marginBottom:"-70px",fontSize:"50px"}}>Contact Us</h1>
          {/* <LoginSignUp /> */}
        </div>
      </>
    );
